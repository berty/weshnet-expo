...
export interface ProtocolServiceClient {
    ...
    debugAuthServiceSetToken: Unary<api.protocol.DebugAuthServiceSetToken.IRequest, api.protocol.DebugAuthServiceSetToken.Reply>,
    systemInfo: Unary<api.protocol.SystemInfo.IRequest, api.protocol.SystemInfo.Reply>,
    authServiceInitFlow: Unary<api.protocol.AuthServiceInitFlow.IRequest, api.protocol.AuthServiceInitFlow.Reply>,
    authServiceCompleteFlow: Unary<api.protocol.AuthServiceCompleteFlow.IRequest, api.protocol.AuthServiceCompleteFlow.Reply>,
    ...
    servicesTokenList: ResponseStream<api.protocol.ServicesTokenList.IRequest, api.protocol.ServicesTokenList.Reply>,
